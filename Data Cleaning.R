...
# R code to clean the web-scrapped data from daft.ie (property/housing website). String split technique was used to segregate the obtained data into meaningful columns. Multivariate Imputation using Chained Equation (MICE) package was used to clean the data. 
